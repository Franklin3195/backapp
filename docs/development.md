...
Before start install MySqlQL and fill correct configurations in `.env` file
...
If you need to use MySql / MariaDB instead of MySqlQL, follow the steps below:
...
##### Docker Compose
After completing the steps above, you can use [this docker-compose file](../docker-compose_MySql.yml) for awesome-nest-boilerplate with MySql (instead of MySqlQL).
